...
def glyph_m(font, xh, a, d, w, t, s, r, ct, bo, rct):
    ...
    path.moveTo((t/2, 2/3*xh))
    path.qCurveTo((t/2, xh+bo), (m*r, xh+bo))
    ...
    path.moveTo((m+t/2, 2/3*xh))
    path.qCurveTo((m+t/2, xh+bo), (m+m*r, xh+bo))
